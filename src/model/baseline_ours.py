...
class Baseline(nn.Module):
    """ Baseline Contrastive Learning Model. Support both NLP and Vision tasks. """
    def __init__(self,
                 backbone_path: str,
                 nb_labels: int,
    ...
    def forward(self,
        ...
        if self.task_type == 'NLP':
            # Check if attention mask is not None
            ...
            return self.projection(final_representation), final_representation
